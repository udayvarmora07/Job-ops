...
type CareerApplication struct {
	...
	// Referral-only fields (populated by data.ParseReferrals from data/referrals.json)
	Contact string // person asked for the referral, e.g. "Parvinder Kaur (HR)"
	Channel string // outreach channel, e.g. "LinkedIn"
