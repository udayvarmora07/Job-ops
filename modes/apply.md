...
5. **jobops proof point**: Include in "Additional info" if there is a field for it
...
3. Suggest next step: run the `contacto` mode (`/jobops contacto` where available) for LinkedIn outreach
