# jobops -- Modalità in italiano (`modes/it/`)

Questa cartella contiene le traduzioni in italiano delle principali modalità di jobops per i candidati che si rivolgono al mercato italiano.
