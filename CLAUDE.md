...
> **New session?** Read [`docs/AI_BRIEFING.md`](docs/AI_BRIEFING.md) for a complete map of this project — web dashboard, API routes, resume pipeline, AI engine, data formats, and user profile. One file, everything you need.
> The web dashboard also has its own [`web/CLAUDE.md`](web/CLAUDE.md) with web-specific rules (auto-loaded when working in `web/`).
...
| Wants ATS score or resume vs JD review | `ats` |
| Wants to update resume based on ATS feedback | `ats` |
