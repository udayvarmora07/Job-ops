...
// Ensures every supported CLI gets .*/skills/jobops/SKILL.md even when the
...
export const CANONICAL_SKILL_PATH = '.agents/skills/jobops/SKILL.md';

export const SKILL_ENTRYPOINTS = [
  {
    path: '.claude/skills/jobops/SKILL.md',
    pointer: '../../../.agents/skills/jobops/SKILL.md',
  },
  {
    path: '.opencode/skills/jobops/SKILL.md',
    pointer: '../../../.agents/skills/jobops/SKILL.md',
  },
  {
    path: '.qwen/skills/jobops/SKILL.md',
    pointer: '../../../.agents/skills/jobops/SKILL.md',
  },
  {
    path: '.antigravitycli/skills/jobops/SKILL.md',
    pointer: '../../../.agents/skills/jobops/SKILL.md',
  },
  {
    path: '.grok/skills/jobops/SKILL.md',
    pointer: '../../../.agents/skills/jobops/SKILL.md',
  },
];
