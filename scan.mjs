...
const PROFILE_PATH = process.env.JOBOPS_PROFILE || 'config/profile.yml';
...
// in modes/pipeline.md and expected by /jobops pipeline.
const PIPELINE_SKELETON = `# Pipeline — Pending URLs

Paste job URLs below as \`- [ ] {url}\` then run \`/jobops pipeline\`.
