...
This file lists who maintains jobops and how contributors grow into review and maintenance roles. It exists so the project doesn't depend on any single person and so the path forward is legible to everyone.
...
Because jobops handles people's personal career data, access is granted carefully:
