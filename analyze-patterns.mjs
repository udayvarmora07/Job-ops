#!/usr/bin/env node
/**
 * analyze-patterns.mjs — Rejection Pattern Detector for jobops
 *
...
const REPORTS_DIR = join(JOBOPS, 'reports');
...
function analyze() {
  ...
  const enriched = entries.map(e => {
    ...
    const reportPath = reportMatch ? join(JOBOPS, reportMatch[1]) : null;
