# Jobops | نظام إدارة وتخطيط البحث عن وظائف باستخدام الذكاء الاصطناعي (وكيل مأتمت)
...
<p align="right" dir="rtl">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="Jobops — نظام البحث عن وظائف القائم على عدة وكلاء ذكاء اصطناعي" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="عرض توضيحي لـ Jobops" width="800">
</p>
...
يقوم **Jobops** ([jobops.org](https://jobops.org)) بتحويل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي (AI coding CLI) إلى مركز قيادة كامل للبحث عن الوظائف. بدلاً من تتبع طلبات التوظيف يدوياً في جداول البيانات، تحصل على مسار عمل مدعوم بالذكاء الاصطناعي يقوم بـ:
...
تم تطوير هذا النظام بواسطة مهندس برمجيات وريادي أعمال استخدمه شخصياً لتقييم أكثر من 740 عرض عمل، وتوليد أكثر من 100 سيرة ذاتية مخصصة، حتى حصل على منصب "رئيس قسم الذكاء الاصطناعي التطبيقي". [اقرأ دراسة الحالة الكاملة](https://santifer.io/jobops-system).
...
يدعم Jobops بشكل أصلي واجهة [Gemini CLI](https://github.com/google-gemini/gemini-cli) بنفس الكفاءة والقواعد التي يدعم بها بيئات التوظيف الأخرى. جميع الأوامر الـ 15 متاحة وتستخدم نفس منطق التقييم تحت المجلد `modes/`.
...
/jobops-evaluate --file ./jds/openai.txt
/jobops-scan
/jobops-pdf
/jobops-tracker
```
...
```text
/jobops                ← لعرض كافة الأوامر المتاحة وتفاصيلها
/jobops {رابط الوظيفة} ← تشغيل المسار التلقائي بالكامل (تقييم + PDF + تسجيل)
/jobops scan           ← مسح بوابات التوظيف بحثاً عن فرص جديدة
/jobops pdf            ← توليد سيرة ذاتية محسنة ومتوافقة مع ATS
/jobops batch          ← تقييم مجموعة وظائف دفعة واحدة بالتوازي
/jobops tracker        ← عرض وتحديث حالات التقديم الحالية
/jobops apply          ← تعبئة نماذج التوظيف والردود بمساعدة الذكاء الاصطناعي
/jobops pipeline       ← معالجة وفحص روابط الوظائف المنتظرة
/jobops contacto       ← صياغة رسائل التواصل الموجهة عبر LinkedIn
/jobops deep           ← إجراء بحث معمق واستخباراتي حول الشركة المستهدفة
/jobops training       ← تقييم دورة تدريبية أو شهادة مهنية ومدى فائدتها لك
/jobops project        ← تقييم مشروع شخصي في معرض أعمالك وكيفية عرضه
```
...
**Jobops هي أداة محلية مفتوحة المصدر بالكامل — وليست خدمة مستضافة.** عند استخدامك لهذا البرنامج، فإنك تقر وتوافق على التالي:
...
<a href="https://github.com/santifer/jobops/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/jobops" alt="Contributors" />
</a>

هل نجحت في الحصول على وظيفة أحلامك باستخدام هذا النظام؟ [شارك قصتك معنا لتلهم الآخرين!](https://github.com/santifer/jobops/issues/new?template=i-got-hired.yml)
